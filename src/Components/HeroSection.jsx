...
export function HeroSection() {
  return (
    <React.Fragment>
      ...
      <div className="min-h-screen bg-[url('https://supergitsa.com/images/erp.webp')] bg-[length:100%_100%] px-4 py-4  bg-center bg-no-repeat flex flex-col items-center justify-center text-center text-white text-4xl font-bold">
        <div className="bg-black/70 p-4 rounded-lg">
          ...
          <p
            data-aos="zoom-in"
            data-aos-delay="500"
            className="text-sm md:text-xl max-w-3xl mb-6"
          >
            Supergit simplifies your accounting, payroll, invoicing, reporting,
          ...
          <div
            ...
            className="flex flex-wrap justify-center gap-4 mt-6 text-lg"
          >
            <button className="px-5 py-2 font-semibold rounded-lg text-[#fab768] bg-white hover:bg-none hover:shadow-none   hover:border-white shadow transition-transform duration-300 cursor-pointer ">
              <span className="bg-gradient-to-r from-[#f14f3e] to-[#fab768] bg-clip-text text-transparent">Get Started</span>
            </button>
            <button className="px-4 py-2 bg-transparent border border-white font-semibold rounded-lg hover:bg-white hover:text-[#f14f3e] transition cursor-pointer">
              See Demo
            </button>
