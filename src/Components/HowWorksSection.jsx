...
const steps = [
  {
    ...
    description:
      "Register your business and setup your organization’s profile and users.",
  },
  {
    icon: <FaCogs className="text-2xl text-[#fab768]" />,
    title: "2. Configure Modules",
    description:
      "Set up accounting structure, payroll, user roles, and system preferences.",
  },
  {
    icon: <FaFileInvoice className="text-2xl text-[#fab768]" />,
    title: "3. Add Financial Data",
    description:
      "Start recording invoices, purchases, expenses, and journal entries easily.",
  },
  {
